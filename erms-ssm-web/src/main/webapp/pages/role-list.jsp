                            ...
                            <c:forEach items="${roleList}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission.do?roleId=${role.id}'">添加权限</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
