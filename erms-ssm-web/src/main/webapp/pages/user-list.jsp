                            ...
                            <c:forEach items="${userList}" var="user">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}'">添加角色</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
